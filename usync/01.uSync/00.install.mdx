...
:::note
uSync v11 runs on Umbraco v11.x. See our [compatibility table](versions) to see which version you need for other Umbraco versions. 
:::
...
### Install as package
:::info
uSync v11 is only available as a nuget package, there is currently no way to install a package directly from the backoffice in umbraco 11 
:::
